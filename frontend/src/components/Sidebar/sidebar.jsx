...
function Sidebar(){
    ...
    return(
        ...
        <div className={`${st.comp} ${st.sidebar_frame}`}>

            <a href="#" className={`${st.links}`} id="home">
                <p>Home</p>
            ...
            <a href="#" className={`${st.links}`} id="skills-tech">
            ...
            <a href="#" className={`${st.links}`} id="projects">
                <p>Projects</p>
            ...
            <a href="#" className={`${st.links}`} id="educations">
                <p>Educations</p>
            ...
            <a href="#" className={`${st.links}`} id="contacts">
                <p>Contacts</p>
            ...
            <a href="#" className={`${st.links}`} id="footer">
                <p>Footer</p>
